    ...
    <div className="bg-white min-h-screen">
       ...
       <div className="container mx-auto px-4 py-8">
          <div className="max-w-3xl mx-auto text-center space-y-8 leading-relaxed text-gray-600">
             ...
             <p>
               Founded in 2020, we started with a small team of three artisans in a cozy studio in Lahore. 
               Our vision was simple: to bring the intricate beauty of traditional embroidery into the playful, dynamic world of children's fashion.
             </p>
             <p>
               We believe that clothes should not just be worn, but experienced. The texture of hand-woven cotton, the brightness of a silk thread, 
               and the comfort of a perfect fit - these are the details we obsess over.
             </p>
          </div>
